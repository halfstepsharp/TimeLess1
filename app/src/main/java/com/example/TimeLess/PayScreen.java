...
public class PayScreen extends AppCompatActivity {
    ...
    public void update_layout(Map<String,Object> data) {
        ...
        Adapter CreditCardAdapter = null;
        for (Map.Entry<String, Object> entry : data.entrySet()) {
            ...
            CreditCardAdapter = (Adapter) new CreditCardAdapter(card_number, card_expiry, info_card);
        }
        cards.setAdapter((RecyclerView.Adapter) CreditCardAdapter);
    }
}
